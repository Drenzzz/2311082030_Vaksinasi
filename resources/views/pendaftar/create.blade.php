                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('lokasi_vaksin') is-invalid @enderror" id="lokasi_vaksin" name="lokasi_vaksin" required>
                            ...
                            <option value="Rumah Sakit Umum Daerah" {{ old('lokasi_vaksin') == 'Rumah Sakit Umum Daerah' ? 'selected' : '' }}>Rumah Sakit Umum Daerah</option>
                            <option value="Rumah Sakit Ibnu Sina" {{ old('lokasi_vaksin') == 'Rumah Sakit Ibnu Sina' ? 'selected' : '' }}>Rumah Sakit Ibnu Sina</option>
                            <option value="Lapangan Kolokala" {{ old('lokasi_vaksin') == 'Lapangan Kolokala' ? 'selected' : '' }}>Lapangan Kolokala</option>
                            <option value="Klinik Doa Ibu" {{ old('lokasi_vaksin') == 'Klinik Doa Ibu' ? 'selected' : '' }}>Klinik Doa Ibu</option>
                            <option value="Kantor Walikota" {{ old('lokasi_vaksin') == 'Kantor Walikota' ? 'selected' : '' }}>Kantor Walikota</option>
                        </select>
                        @error('lokasi_vaksin')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
